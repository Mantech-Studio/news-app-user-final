                ...
                Center(
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(image: AssetImage('assets/NewsLogo.png'),fit: BoxFit.contain),
                    ),
                  ),
                ),
                Center(
                  child: Text('Please enter your details',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.orange,
                    /*
                      shadows: <Shadow>[
                        Shadow(
                        ...
                        child: Column(
                          children: [
                            ...
                            Expanded(
                              child: Container(
                                decoration: BoxDecoration(
                                  image: DecorationImage(image: AssetImage('assets/HawaMahal.jpg'),fit: BoxFit.fill),
                                ),
                                child: Center(
